                ...
                <div className="h-72">
                  <ResponsiveContainer width={"100%"} height={"100%"}>
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="count" reduis={[8, 8, 0, 0]}>
                  ...
                  <div key={n._id} className="flex items-center text-sm">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        <span
                          className={`px-2 py-0.5 rounded text-sm font-medium ${getBadgeClasses("type", n.type)} capitalize`}
                        >
                          {n.type}
                        </span>
                        <span
                          className={`px-2 py-0.5 rounded text-sm font-medium capitalize ${getBulletColor(n.type, n.priority)}`}
                        >
                          {n.priority}
                        </span>
                      </div>
